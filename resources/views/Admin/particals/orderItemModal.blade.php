@foreach ($orders as $order)
    <!-- Modal -->
    <div class="modal fade" id="orderItem{{$order->orderid}}" tabindex="-1" role="dialog" aria-labelledby="orderItem{{$order->orderid}}" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header text-light" style="background: #4b5366;">
                    <h5 class="modal-title" id="orderItem{{$order->orderid}}">Order Items Order Id: {{ $order->orderid }}</h5>
