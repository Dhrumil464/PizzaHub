            ...
            <table class="table table-striped table-hover text-center" id="NoOrder">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$paymentMode}}</td>
                        <td>' . $orderDate . '</td>
                        <td><a href="" data-toggle="modal" data-target="#orderStatus"
                                class="view"><i class="material-icons">&#xE5C8;</i></a></td>
                        <td><a href="" data-toggle="modal" data-target="#orderItem"
                                class="view" title="View Details"><i class="material-icons">&#xE5C8;</i></a></td>
                    </tr>
                    @if ($counter == 0)
                        <script>
