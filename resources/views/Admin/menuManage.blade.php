            ...
            <div class="col-md-4">
                <form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
                    <div class="card" style="border-radius: 12px;">
                        <div class="card-header text-light" style="background-color: #4b5366;border-top-right-radius: 12px; border-top-left-radius: 12px;">
                            Create New Item
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="mx-auto">
                                    <button type="submit" name="createItem" class="btn btn-md btn-primary"> Create
                                    </button>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <td class="text-center">
                                            <div class="row mx-auto" style="width:112px">
                                                <button class="btn btn-sm btn-primary" type="button"
                                                    data-toggle="modal" data-target="#updateItem">Edit</button>
